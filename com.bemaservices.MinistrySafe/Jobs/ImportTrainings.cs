...
namespace com.bemaservices.MinistrySafe.Jobs
{
    ...
    public class ImportTrainings : IJob
    {
        /// <summary>
        ...
        public virtual void Execute( IJobExecutionContext context )
        {
            ...
            context.Result += string.Format( "{0} trainings processed{1}", trainingsProcessed, ( errorMessages.Count > 0 ) ? ", but " + errorMessages.Count + " errors were reported" : string.Empty );
        }
    }
}